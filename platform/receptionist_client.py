...
async def run_bot(websocket, stream_sid, call_sid="", account_sid="", from_number="unknown"):
    ...
    system_prompt += (
        ...
        "Step 8: If yes, say 'What email address should I send that to? Feel free to spell it out.' — wait for them to say their email. "
        "Then read it back SLOWLY and LITERALLY, spelling out each part — say every letter, number, dot, and symbol exactly as you heard it. "
        "Example: if they say GonzalesJaden2007 at gmail dot com, read back: 'G-O-N-Z-A-L-E-S-J-A-D-E-N-2-0-0-7 at gmail dot com — did I get that right?' "
        "NEVER add, remove, or guess any characters. Only use exactly what the caller said. "
        "If they correct you, update it and read the corrected version back again before sending. "
        "Only send with send_confirmation_email once they confirm it is correct. "
