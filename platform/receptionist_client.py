...
async def run_bot(websocket, stream_sid, call_sid="", account_sid="", from_number="unknown"):
    ...
    system_prompt += (
        ...
        "Step 8: If yes, say 'What's your email?' and wait. "
        "Listen carefully — do NOT autocorrect or assume spelling. 'at' means @, 'dot' means period. "
        "Once you have it, read it back naturally: 'Got it — [email address]. Is that right?' "
        "If anything sounds ambiguous (like S vs Z), ask one quick question: 'Is that S or Z?' then confirm again. "
        "If they correct you, repeat the corrected email back and ask again. "
        "Only send with send_confirmation_email once they confirm it's correct. "
